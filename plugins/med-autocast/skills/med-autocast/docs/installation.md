...
.venv/bin/python runtime/native_helpers/med_autocast.py --help
```

随包辅助程序位于技能目录中的 runtime/native_helpers/med_autocast.py。实际视频生成、剪辑和打包需要已配置的制作工作区及可用媒体后端。原始媒体、后端凭据和本机恢复档案留在制作工作区。
