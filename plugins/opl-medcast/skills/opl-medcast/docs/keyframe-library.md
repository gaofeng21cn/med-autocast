...
查询：`python3 runtime/native_helpers/medcast.py assets --workspace /absolute/workspace --category 05`。更新库使用制作工作区已验证的build_keyframe_library.py；入库决定由AI/owner做，不自动收录所有图片。
